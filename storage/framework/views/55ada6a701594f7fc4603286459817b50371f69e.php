...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		...
		<div class="page-rightheader">
			<a href="<?php echo e(route('admin.finance.promocodes.create')); ?>" class="btn btn-primary mt-1"><?php echo e(__('Create New Promocode')); ?></a>
		</div>
	</div>	
	<!-- END PAGE HEADER -->
<?php $__env->stopSection(); ?>
					...
					<table id='promocodesAdminTable' class='table' width='100%'>
							<thead>
								<tr>
									...
									<th width="10%"><?php echo e(__('Promo Type')); ?></th>
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#promocodesAdminTable').DataTable({
				...
				"order": [[ 7, "asc" ]],
				language: {
					"emptyTable": "<div><br><?php echo e(__('No promocodes created yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/finance/promocodes/index.blade.php ENDPATH**/ ?>