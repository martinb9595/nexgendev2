																	...
																	<?php $__currentLoopData = $extensions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $extension): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<?php if($extension->slug == $theme['slug']): ?>
																			<?php if($extension->purchased && !$extension->installed): ?>
																				<a href="<?php echo e(route('admin.theme.purchase', $theme['slug'])); ?>" class="btn btn-primary ripple" style="width: 250px; text-transform: none; font-size: 11px; padding-top: 10px; padding-bottom: 10px;"><?php echo e(__('Install Theme')); ?></a>	
																			<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/themes/index.blade.php ENDPATH**/ ?>