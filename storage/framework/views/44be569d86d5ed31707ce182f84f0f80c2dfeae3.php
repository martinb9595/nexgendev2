			...
			.then(data => {
				...
				eventSource.onmessage = function (e) {
					...
					if (e.data == "[DONE]") {
						...
						let txt;
						if (uploaded_image == '') {
							if (model == 'claude-3-haiku-20240307' || model == 'claude-3-5-sonnet-20240620' || model == 'claude-3-opus-20240229' || model == 'gemini_pro') {
								txt = e.data;
							} else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/user/chat/view.blade.php ENDPATH**/ ?>