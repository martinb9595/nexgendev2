								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="support-ticket" name="support-ticket" class="form-select">	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="user-notification" name="user-notification" class="form-select">	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											...
											<select id="user-support" name="user-support" class="form-select">	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6><?php echo e(__('Default Main Theme')); ?></h6>
											<select id="theme" name="theme" class="form-select">	
												<option value="light" <?php echo e((config('settings.default_theme') == 'light') ? 'selected' : ''); ?>><?php echo e(__('Light Theme')); ?></option>
												<option value="dark" <?php echo e((config('settings.default_theme') == 'dark') ? 'selected' : ''); ?>><?php echo e(__('Dark Theme')); ?></option>																		
											</select> 
										</div> 
									</div>
								</div>
...
unset($__errorArgs, $__bag); ?>
								...
								<h6 class="fs-12 font-weight-bold mb-4"><?php echo e(__('GA4 for Admin Panel')); ?></h6>

								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box mt-2">								
											<h6><?php echo e(__('Google Analytics Property ID')); ?></h6>
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['google-property'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="google-property" name="google-property" value="<?php echo e(config('services.google.analytics.property')); ?>" autocomplete="off">
												<?php $__errorArgs = ['google-property'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
													<p class="text-danger"><?php echo e($errors->first('google-property')); ?></p>
												<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">								
										<!-- ACCESS KEY -->
										<div class="input-box mt-2">								
											<h6><?php echo e(__('Google Service Account Credentials')); ?></h6>
											<div class="form-group">							    
												<input type="text" class="form-control <?php $__errorArgs = ['google-credentials'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="google-credentials" name="google-credentials" value="<?php echo e(config('services.google.analytics.credentials')); ?>" autocomplete="off">
												<?php $__errorArgs = ['google-credentials'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
													<p class="text-danger"><?php echo e($errors->first('google-credentials')); ?></p>
												<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/settings/global/index.blade.php ENDPATH**/ ?>