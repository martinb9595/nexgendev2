    ...
    <ul class="side-menu app-sidebar3">
        ...
        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
            ...
            <li class="slide">
                ...
                <span class="side-menu__icon lead-3 fa-solid fa-palette"></span>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('#')); ?>">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="<?php echo e(route('admin.settings.case')); ?>" class="slide-item"><?php echo e(__('Use Cases Section')); ?></a></li>                                           
                        ...
                        <li><a href="<?php echo e(route('admin.settings.client')); ?>" class="slide-item"><?php echo e(__('Clients Section')); ?></a></li>                      
...
<!-- END SIDE MENU BAR --><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/layouts/dashboard/nav-aside.blade.php ENDPATH**/ ?>