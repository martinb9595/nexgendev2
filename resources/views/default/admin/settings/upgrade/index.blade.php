				...
				<div class="changelog">
					...
					<div class="changelog-description mt-6"> 
						<ul>								
							...
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13"></span>Show purchased themes during fresh install improved</li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13"></span>Credits adding via manual subscription plan assignment improved</li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13"></span>Frontend clients list updatable via admin panel now</li>
							<li><span class="version-update mr-2">Update</span> <span class="text-muted fs-13"></span>Frontend new features list improved</li>
