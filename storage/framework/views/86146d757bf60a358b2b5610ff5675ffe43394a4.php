										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<select class="form-select" id="templates-models-list" name="templates_models_list[]" data-placeholder="<?php echo e(__('Choose Models for Templates')); ?>" multiple>
													...
													<option value='claude-3-5-sonnet-20240620' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-5-sonnet-20240620'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3.5 Sonnet')); ?></option>																																																																																																																											
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<select class="form-select" id="chats-models-list" name="chats_models_list[]" data-placeholder="<?php echo e(__('Choose Models for Chat Bots')); ?>" multiple>
													...
													<option value='claude-3-opus-20240229' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-opus-20240229'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3 Opus')); ?></option>																																																																																																																											
													<option value='claude-3-5-sonnet-20240620' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-5-sonnet-20240620'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3.5 Sonnet')); ?></option>																																																																																																																											
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">
													...
													<select id="sd-image-engine" name="sd-image-engine" class="form-select">
														...
														<option value='sd3-medium' <?php if($id->sd_image_engine == 'sd3-medium'): ?> selected <?php endif; ?>> <?php echo e(__('SD 3.0 Medium')); ?></option>		
														<option value='sd3-large' <?php if($id->sd_image_engine == 'sd3-large'): ?> selected <?php endif; ?>> <?php echo e(__('SD 3.0 Large')); ?></option>		
														<option value='sd3-large-turbo' <?php if($id->sd_image_engine == 'sd3-large-turbo'): ?> selected <?php endif; ?>> <?php echo e(__('SD 3.0 Large Turbo')); ?></option>		
														<option value='core' <?php if($id->sd_image_engine == 'core'): ?> selected <?php endif; ?>> <?php echo e(__('Stable Image Core')); ?></option>	
														<option value='ultra' <?php if($id->sd_image_engine == 'ultra'): ?> selected <?php endif; ?>> <?php echo e(__('Stable Image Ultra')); ?></option>	
													</select>
												</div>
											</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/finance/plans/edit.blade.php ENDPATH**/ ?>