	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#allNotificationsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><img id='no-results-img' src='<?php echo e(theme_url('img/files/no-notification.png')); ?>'><br>There are no pending system notifications yet</div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/notification/system.blade.php ENDPATH**/ ?>