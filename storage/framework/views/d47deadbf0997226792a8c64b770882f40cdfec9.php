									...
									<div class="row">
										...
										<div class="col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="o1_preview" name="o1_preview" value="0" placeholder="0">
													<span class="text-muted fs-10"><?php echo e(__('Each text generation task counts output words created')); ?>. <?php echo e(__('Set as -1 for unlimited words')); ?>. (<?php echo e(__('1 credit = 1 word')); ?>).</span>
												</div> 
											</div> 						
										</div>
										...
										<div class="col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="o1_mini" name="o1_mini" value="0" placeholder="0">
													<span class="text-muted fs-10"><?php echo e(__('Each text generation task counts output words created')); ?>. <?php echo e(__('Set as -1 for unlimited words')); ?>. (<?php echo e(__('1 credit = 1 word')); ?>).</span>
												</div> 
											</div> 						
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<select class="form-select" id="templates-models-list" name="templates_models_list[]" data-placeholder="<?php echo e(__('Choose Models for Templates')); ?>" multiple>									
													...
													<option value='o1-preview'><?php echo e(__('o1 preview')); ?></option>																																																																																																																																																																																																																																																						
													<option value='o1-mini'><?php echo e(__('o1 mini')); ?></option>																																																																																																																																																																																																																																																						
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/finance/plans/create.blade.php ENDPATH**/ ?>