							...
							<div class="col-md-12 col-sm-12" >									
								<div id="chat-container">
									<div class="msg left-msg">
										<div class="message-img" style="background-image: url(<?php echo e(URL::asset($chat->logo)); ?>)"></div>
										<div class="message-bubble">					
											<div class="msg-text"><?php if(!is_null($chat->description)): ?> <?php echo e(__($chat->description)); ?> <?php else: ?> <?php echo e(__('Hi there! How can I help you today?')); ?> <?php endif; ?></div>
										</div>
									</div>
...
unset($__errorArgs, $__bag); ?>" rows="1" id="message" name="message" placeholder="<?php echo e(__('Type your message here...')); ?>"></textarea>
									...
									<div class="flex mt-3">
										...
										<?php if($chat->upload): ?>
											...
											<a class="btn btn-primary-chat fs-11 text-muted mb-2" href="javascript:void(0)" id="file-upload-button-main"><i class="fa-solid fa-file-invoice"></i> <span><?php echo e(__('Upload Document')); ?></span></a>
										<?php endif; ?>
									</div>
								...
								<div class="flex" id="templates-panel">			
									<div class="row chat-model-box pl-5 pr-5 pt-2 pb-2">
										...
										<?php if($chat->type == 'private'): ?>
											<?php if(trim($chat->model) == 'gpt-3.5-turbo-0125'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_01" name="model" onclick="handleClick(this);" value="gpt-3.5-turbo-0125">
													<label for="control_01">
														...
														<p class="text-muted" style="position: absolute; bottom: 7px; opacity: 0.8; left: 0; right: 0; font-size: 9px;">
															...
															<?php else: ?>
																<?php echo e(App\Services\HelperService::userAvailableWords()); ?>

															<?php endif; ?> <?php echo e(__('Words Available')); ?>

														</p>
													</label>
												</div>
											<?php elseif(trim($chat->model) == 'gpt-4o'): ?>
												<div class="col-md-4 col-sm-12">
													<input type="radio" id="control_10" name="model" onclick="handleClick(this);" value="gpt-4o">
													<label for="control_10">
														...
														<p class="text-muted" style="position: absolute; bottom: 7px; opacity: 0.8; left: 0; right: 0; font-size: 9px;">
															...
															<?php else: ?>
																<?php echo e(App\Services\HelperService::userAvailableGPT4oWords()); ?>
											...
											<?php elseif(trim($chat->model) == 'gpt-4-0125-preview'): ?>
												<div class="col-md-4 col-sm-12">
													...
													<label for="control_03">
														...
														<p class="text-muted" style="position: absolute; bottom: 7px; opacity: 0.8; left: 0; right: 0; font-size: 9px;">
															...
															<?php else: ?>
																<?php echo e(App\Services\HelperService::userAvailableGPT4TWords()); ?>
											...
											<?php elseif(trim($chat->model) == 'gpt-4-turbo-2024-04-09'): ?>
												<div class="col-md-4 col-sm-12">
													...
													<div class="col-md-4 col-sm-12">
														...
														<label for="control_02">
															...
															<p class="text-muted" style="position: absolute; bottom: 7px; opacity: 0.8; left: 0; right: 0; font-size: 9px;">
																...
																<?php else: ?>
																	<?php echo e(App\Services\HelperService::userAvailableGPT4Words()); ?>
															...
															<div class="col-md-4 col-sm-12">
																...
																<label for="control_<?php echo e($key); ?>_f">
																	...
																	<p class="text-muted" style="position: absolute; bottom: 7px; opacity: 0.8; left: 0; right: 0; font-size: 9px;">
																		...
																		<?php else: ?>
																			<?php echo e(App\Services\HelperService::userAvailableFineTuneWords()); ?>
				...
				success: function (data) {
					...
					if (data['status'] == 'success') {
						...
						$('.chat-sidebar-messages').prepend(`<div class="chat-sidebar-message selected-message" id=${data['id']}>
								...
								<div class="chat-actions d-flex">
									<a href="#" class="chat-edit fs-12" id="${data['id']}"><i class="fa-sharp fa-solid fa-pen-to-square" data-tippy-content="<?php echo e(__('Edit Name')); ?>"></i></a>
									<a href="#" class="chat-delete fs-12 ml-2"  id="${data['id']}"><i class="fa-sharp fa-solid fa-trash" data-tippy-content="<?php echo e(__('Delete Chat')); ?>"></i></a>
								</div>
							</div>`);
						active_id = data['id'];	
					} else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/user/chat/view-custom.blade.php ENDPATH**/ ?>