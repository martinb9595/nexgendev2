...
<?php $__env->startSection('metadata'); ?>
    <meta name="description" content="<?php echo e(__($metadata->register_description)); ?>">
    <meta name="keywords" content="<?php echo e(__($metadata->register_keywords)); ?>">
    <meta name="author" content="<?php echo e(__($metadata->register_author)); ?>">	    
    <link rel="canonical" href="<?php echo e($metadata->register_url); ?>">
...
unset($__errorArgs, $__bag); ?>                            
                                        ...
                                        <div class="form-group mb-2">  
                                            <div class="d-flex">                        
                                                <label class="custom-switch">
                                                    ...
                                                    <span class="custom-switch-description fs-10 text-muted"><?php echo e(__('By continuing, I agree with your Terms and Conditions and Privacy Policies')); ?></span>
                                                </label>   
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-6 col-sm-12 text-center background-special align-middle p-0" id="login-background">
                        <div class="login-bg">
                            <img src="<?php echo e(theme_url('img/frontend/backgrounds/login.webp')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('js'); ?>
	...
	<script src="<?php echo e(theme_url('js/awselect.js')); ?>"></script>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/auth/register.blade.php ENDPATH**/ ?>