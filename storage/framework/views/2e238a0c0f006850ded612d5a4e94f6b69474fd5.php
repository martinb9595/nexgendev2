	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#allSupportRequestsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><img id='no-results-img' src='<?php echo e(theme_url('img/files/no-support.png')); ?>'><br><?php echo e(__('No created support tickets yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/admin/support/index.blade.php ENDPATH**/ ?>