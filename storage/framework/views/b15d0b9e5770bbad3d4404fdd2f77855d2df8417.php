		...
		<div class="col-lg-9 col-md-12 col-sm-12 mt-4">
			<div class="card border-0">
				<div class="card-header">
					...
					<a href="<?php echo e(route('user.chat.custom.create')); ?>" class="btn btn-cancel ripple" style="margin-left: auto"><?php echo e(__('Create New Chat Assistant')); ?></a>
				</div>
					...
					<table id='allTemplates' class='table' width='100%'>
						<thead>
							<tr>							
								...
								<th width="3%"><?php echo e(__('Model')); ?></th>					
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/viralhub/public_html/nexgen.to/resources/views/default/user/chat/custom/index.blade.php ENDPATH**/ ?>